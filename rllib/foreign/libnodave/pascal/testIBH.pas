...
(*    daveDebug:=daveDebugAll; *)
	    ...
	    val(copy(paramstr(adrPos),7,100),MPIadr);
	    writeln('setting MPI to ',MPIadr);
	end 
	...
	dc :=daveNewConnection(di,MPIadr,0,0);  // insert your PPI address here
