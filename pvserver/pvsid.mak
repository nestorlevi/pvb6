#############################################################################
# Makefile for building: libpvsid.so.1.0.0
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  pvsid.pro
# Template: lib
# Command: /usr/bin/qmake6 -o pvsid.mak pvsid.pro -spec linux-clang
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = pvsid1.0.0
DISTDIR = /home/lehrig/pvb6/pvserver/.tmp/pvsid1.0.0
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -shared -ldl -Wl,-soname,libpvsid.so.1
...
DIST          = /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		...
		pvsid.pro BMP.h \
		processviewserver.h \
		pvbImage.h glencode.cpp \
		pvbImage.cpp \
		util.cpp
QMAKE_TARGET  = pvsid
DESTDIR       = 
TARGET        = libpvsid.so.1.0.0
TARGETA       = libpvsid.a
TARGET0       = libpvsid.so
TARGETD       = libpvsid.so.1.0.0
TARGET1       = libpvsid.so.1
TARGET2       = libpvsid.so.1.0


first: all
####### Build rules

libpvsid.so.1.0.0:  $(OBJECTS) $(SUBLIBS) $(OBJCOMP)  
...
staticlib: libpvsid.a

libpvsid.a:  $(OBJECTS) $(OBJCOMP) 
	-$(DEL_FILE) $(TARGETA) 
	$(AR) $(TARGETA) $(OBJECTS)

pvsid.mak: pvsid.pro /usr/lib64/qt6/mkspecs/linux-clang/qmake.conf /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt6/mkspecs/common/unix.conf \
		/usr/lib64/qt6/mkspecs/common/linux.conf \
		/usr/lib64/qt6/mkspecs/common/sanitize.conf \
		/usr/lib64/qt6/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt6/mkspecs/features/lex.prf \
		pvsid.pro
	$(QMAKE) -o pvsid.mak pvsid.pro -spec linux-clang
...
all: pvsid.mak libpvsid.so.1.0.0
