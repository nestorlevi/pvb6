...
MainWindow::MainWindow()
{
  ...
  //printf("within mainwindow.cpp MainWindow: 1\n");
#ifdef BROWSERPLUGIN
  //printf("within mainwindow.cpp MainWindow: 1-1\n");
  pvbinit();
#endif

  //printf("within mainwindow.cpp MainWindow: 2\n");
  isReconnect = 0;
#ifndef NO_WEBKIT  
  textbrowser = NULL;
#endif  
  ...
  //printf("within mainwindow.cpp MainWindow: 3\n");
  cptr = readIniFile();
  //printf("within mainwindow.cpp MainWindow: 4\n");
  if(cptr != NULL)
  {
  ...
  //printf("within mainwindow.cpp MainWindow: 5\n");
  // setup watchdog
  timer = new QTimer();
  ...
  //printf("within mainwindow.cpp MainWindow: 6\n");
  ...
  if(opt.exitpassword == 1)
  {
    ...
    if( ok && !pass.isEmpty() ) 
    {
      ...
      else
      {
        ...
        {
          QMessageBox::information(this,"pvbrowser","Wrong Password",QMessageBox::Ok);
          event->ignore();
        }
        else
        { 
...
void MainWindow::about()
{
 QMessageBox::about(this, tr("About pvbrowser"),
            tr(
               ...
               "\n(C) 2000-2025 Lehrig Software Engineering"
               "\nlehrig@t-online.de"
               "\nhttp://pvbrowser.org"
               "\nhttp://www.lehrig.de"
               "\n"
...
void MainWindow::createToolBars()
{
  ...
  */                            
  ...
  // murx.rl.was.here connect(urlComboBox, SIGNAL(activated(const QString &)), this, SLOT(slotUrl(const QString &)));
  connect(urlComboBox, SIGNAL(currentTextChanged(const QString &)), this, SLOT(slotUrl(const QString &)));
