...
void MyComboBox::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QComboBox::enterEvent((QEnterEvent *)event);
}
...
void MySlider::enterEvent(QEnterEvent *event)
{
  ...
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QSlider::enterEvent((QEnterEvent *) event);
}
...
void MyCheckBox::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QCheckBox::enterEvent((QEnterEvent *) event);
}
...
void MyRadioButton::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QRadioButton::enterEvent((QEnterEvent *) event);
}
...
void MyButtonGroup::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
...
void MyFrame::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
...
void MyQTabWidget::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
...
void MyQToolBox::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
...
void MyGroupBox::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
...
void MyListBox::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QListWidget::enterEvent((QEnterEvent *) event);
}
...
void MyTable::saveTextfile(const char *filename)
{
  ...
  if(filename == NULL)
  {
    ...
    {
      fclose(fp);
      ret = QMessageBox::warning(this,"Save Table","File already exists: Overwrite ?",QMessageBox::Yes,QMessageBox::No);
  ...
  if(fp == NULL)
  {
    QMessageBox::warning(this,"Save Table","could not write file",QMessageBox::Ok);
    return;
  }
...
void MyTable::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QTableWidget::enterEvent((QEnterEvent *) event);
}
...
void MySpinBox::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QSpinBox::enterEvent((QEnterEvent *) event);
}
...
void MyDial::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QDial::enterEvent((QEnterEvent *) event);
}
...
void MyProgressBar::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QProgressBar::enterEvent((QEnterEvent *) event);
}
...
void MyMultiLineEdit::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QTextEdit::enterEvent((QEnterEvent *) event);
}
...
void MyListView::enterEvent(QEnterEvent *event)
{
  ...
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QTreeWidget::enterEvent((QEnterEvent *) event);
}
...
void MyIconView::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
...
void MyQwtKnob::setRange(int vmin, int vmax, int step) 
{ //rlmurx-was-here
#ifdef PVB_FOOTPRINT_OLD_VERSION_BEFORE_QWT62
...
void MyQwtSlider::setBgStyle(int s)
{ //rlmurx-was-here
#ifdef PVB_FOOTPRINT_OLD_VERSION_BEFORE_QWT62
...
void MyQDateEdit::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QDateEdit::enterEvent((QEnterEvent *) event); // murx.rl.was.here
}
...
void MyQTimeEdit::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QTimeEdit::enterEvent((QEnterEvent *) event); // murx.rl.was.here
}
...
void MyQDateTimeEdit::enterEvent(QEnterEvent *event)
{
  char buf[100];
  sprintf(buf, "mouseEnterLeave(%d,1)\n",id);
  tcp_send(s,buf,strlen(buf));
  QDateTimeEdit::enterEvent((QEnterEvent *) event); // murx.rl.was.here
}
