...
Source:    http://pvbrowser.de/pvbrowser/tar/pvb6/pvbrowser-6.tar.gz
...
%if 0%{?suse_version}
Requires:      libqt6 libpng
BuildRequires: tcsh clang qt6-creator-plugin-devel qt6-svg-devel qt6-uitools-devel qt6-widgets-devel qt6-base-common-devel qt6-webenginecore-devel qt6-webenginewidgets-devel libQt6Concurrent6 libQt6Gui6 libQt6WebEngineWidgets6 libQt6OpenGL6 libQt6OpenGLWidgets6 libQt6Sql6 libQt6PrintSupport6 libQt6UiTools6 libQt6Svg6 libQt6SvgWidgets6 libQt6Multimedia6 gcc gcc-c++ libreadline6 readline-devel fdupes cmake
%endif

%if 0%{?fedora_version}
Requires:  qt6-qtbase
BuildRequires: clang libvpl-devel libstdc++-devel lcms-devel qt6-qtwayland-devel qt6-webenginecore-devel qt6-webenginewidgets-devel qt6-qtbase-devel qt6-qtmultimedia-devel qt6-qtsvg-devel qt6-qttools-common qt6-qttools-static qt6-qttools qt6-qttools-devel readline-devel fdupes
# BuildRequires: qt5-qtwebengine-devel qt5-qtenginio-devel
%endif

%if 0%{?rhel_version}
Requires:  qt6-qtbase
BuildRequires: clang libstdc++-devel qt6-qtbase-devel qt6-qtenginio-devel qt6-qtmultimedia-devel qt6-qtsvg-devel qt6-qttools-common qt6-qttools-static qt6-qttools readline-devel
# BuildRequires: libvpl qt5-qtwebengine-devel qt5-qtenginio-devel
%endif
