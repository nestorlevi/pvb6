...
Function AddToPath
  ...
  ReadEnvStr $1 PATH
  DetailPrint "Checking PATH $1 for maximum length of 1024 characters"
  StrCmp $1 "" "" MaxLengthOk
    MessageBox MB_OK "Did not set PATH because your existing PATH is too long (limit=1024 characters)"
    Goto AddToPath_done
  MaxLengthOk:
  DetailPrint "Maximum length of PATH is OK"
  Push "$1;"
  Push "$0;"
  Call StrStr
  Pop $2
...
Function AddToEnvVar
  ...
  AddToEnvVar_NT:
    ...
    ; REMRL StrCpy $3 $2 1 -1 # copy last char
    ; REMRL StrCmp $3 ";" 0 +2 # if last char == ;
    ; REMRL  StrCpy $2 $2 -1 # remove last char
    ; REMRL StrCmp $2 "" AddToEnvVar_NTdoIt
    ; REMRL  StrCpy $1 "$2;$1"
    ; REMRL AddToEnvVar_NTdoIt:
