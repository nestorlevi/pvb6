...
:MINGW
set MINGWDIR=C:\Qt\qt6.8\Tools\mingw1310_64
set QTDIR=C:\Qt\qt6.8
set QMAKESPEC=C:\Qt\qt6.8\Tools\QtDesignStudio\qt6_design_studio_reduced_version\mkspecs\win32-g++
set swigdir=C:\rl\swigwin-3.0.12
set PATH=%MINGWDIR%\bin;C:\Qt\qt6.8\Tools\QtDesignStudio\qt6_design_studio_reduced_version\bin;c:\windows;c:\windows\system32;%PATH%
:END
