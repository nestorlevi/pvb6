# murx.rl.was.here.oct.2023 QT     += printsupport uitools widgets opengl svg
# murx.rl nov 2024 QT     += printsupport widgets opengl svg
QT     += printsupport uitools widgets svg
QT     -= opengl
